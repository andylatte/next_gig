...
ActiveRecord::Schema.define(version: 20171027165909) do
  ...
  create_table "cargos", id: :serial, force: :cascade do |t|
    ...
    t.index ["tour_day_id"], name: "index_cargos_on_tour_day_id"
  end
  ...
  create_table "contacts", force: :cascade do |t|
    ...
    t.bigint "tour_day_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["tour_day_id"], name: "index_contacts_on_tour_day_id"
  end

  create_table "crew_memberships", id: :serial, force: :cascade do |t|
    t.integer "tour_manager_id"
    t.integer "crew_member_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["tour_manager_id"], name: "index_crew_memberships_on_tour_manager_id"
  end
  ...
  create_table "hotels", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["tour_day_id"], name: "index_hotels_on_tour_day_id"
  end
  ...
  create_table "productions", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["tour_day_id"], name: "index_productions_on_tour_day_id"
  end

  create_table "schedule_items", id: :serial, force: :cascade do |t|
    t.string "name"
    t.string "for_whom"
    t.string "number"
    t.string "origin"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["tour_day_id"], name: "index_schedule_items_on_tour_day_id"
  end

  create_table "tour_days", id: :serial, force: :cascade do |t|
    t.date "date"
    t.string "show_name"
  ...
  create_table "tour_memberships", id: :serial, force: :cascade do |t|
    t.integer "user_id"
    t.integer "tour_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "venues", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["tour_day_id"], name: "index_venues_on_tour_day_id"
  end
